...
export default function Level3() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      if (!k2) router.push("/xenith/level2");
    }
  }, [router]);
  ...
  function submit(e?: React.FormEvent) {
    ...
    if (!/^[^@\s]+@iitp\.ac\.in$/.test(email)) {
      alert("Enter a valid IITP email (example@iitp.ac.in).");
      return;
    }
  ...
  return (
    ...
    >
        ...
        <header className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-300">
              The final step! Enter your details and the Level 2 key to complete the event.
            </p>
          </div>
            ...
            <div className="flex flex-col gap-6 justify-center">
              <div className="rounded-xl p-6 bg-gradient-to-br from-amber-500/8 to-yellow-400/6 border border-white/6">
                ...
                <p className="mt-2 text-sm text-slate-200">
                  Enter the Level 2 key and your details to receive the final completion key.
                </p>
                ...
                <div className="mt-6 flex items-center gap-3">
                  ...
                  <div className="text-sm text-slate-300">
                    The ultimate completion key awaits!
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col justify-center">
              <form onSubmit={submit} className="space-y-4">
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button
                    type="button"
                    onClick={() => router.push("/xenith/level2")}
                ...
                <div className="pt-2 text-xs text-slate-400">
                  Final key stored locally — use server verification for real events.
                </div>
              </form>
            </div>
      ...
      <Modal
        open={modalOpen}
        title={generatedKey ? "Final Level Completed!" : "Invalid Submission"}
        subtitle={
          generatedKey
            ? "Congratulations! This is your final completion key. Well done!"
            : "Your Level 2 key or details are incorrect."
        }
